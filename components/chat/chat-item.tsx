...
import { Delete, Edit, FileIcon, FileType, ShieldAlert, ShieldCheck, Trash } from "lucide-react";
            ...
            <div className="flex flex-col w-full">
                ...
                {!fileUrl && !isEditing && (
                    <p className={cn("text-sm text-zinc-600 dark:text-zinc-300", deleted && "italic text-zinc-500 dark:text-zinc-400 text-xs mt-1")}>
                        {content}
                        {isUpdated && !deleted && (
                            <span className="text-[10px] mx-2 text-zinc-500 dark:text-zinc-400"> (edited)
