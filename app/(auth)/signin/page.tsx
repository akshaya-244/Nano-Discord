...
const Signin = () => {
  ...
  return (
    ...
    >
      <div className="text-white mr-10 mt-20 font-mono font-bold text-7xl ml-10 md:ml-0 md:text-9xl">
        <span className="md:text-6xl text-5xl">Nano</span><br></br>Discord
      </div>
      <div className="text-blue-500 mt-5 text-xl font-light font-sans italic sm:text-lg">
      ...
      <div>
        <Button
          onClick={handleClick}
          size="lg"
          className="text-xl mt-10 bg-white font-mono text-black sm:text-lg"
        >
          LOGIN
        </Button>
      </div>
